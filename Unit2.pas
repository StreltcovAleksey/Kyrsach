...
var ssss: string;
    k: integer;
begin
ssss:= 'Вы собираетесь удалить специальность "'+ Qs.fieldbyName ('NameS').AsString+'"?';
...
procedure TForm2.VisiBtnS(fl: boolean); // управление доступностью компонентов ведения списка товаров в приходном документе
begin
