...
var ssss: string;
    k: integer;
begin
ssss:= 'Вы собираетесь удалить вид страховки "'+ Qs.fieldbyName ('Vid').AsString+'"?';
...
procedure TForm4.VisiBtnS(fl: boolean); // управление доступностью компонентов ведения списка товаров в приходном документе
begin
